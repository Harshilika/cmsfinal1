...
$student_class = mysqli_fetch_assoc($student_query)['class_id'];

// Fetch the class name based on class_id
$class_name_query = mysqli_query($db_conn, "SELECT title FROM classes WHERE id = '$student_class'");
...
<section class="content">
    <div class="container-fluid">
        ...
        <!-- Display Timetable for Student's Class -->
        <div class="card">
            <div class="card-body">
